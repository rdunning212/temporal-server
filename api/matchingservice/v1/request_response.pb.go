...
import (
	...
	v114 "go.temporal.io/server/api/enums/v1"
...
type ApplyNexusEndpointReplicationEventRequest struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	Endpoint      *v110.NexusEndpointEntry    `protobuf:"bytes,1,opt,name=endpoint,proto3" json:"endpoint,omitempty"`
	Operation     v114.NexusEndpointOperation `protobuf:"varint,2,opt,name=operation,proto3,enum=temporal.server.api.enums.v1.NexusEndpointOperation" json:"operation,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ApplyNexusEndpointReplicationEventRequest) Reset() {
	*x = ApplyNexusEndpointReplicationEventRequest{}
	mi := &file_temporal_server_api_matchingservice_v1_request_response_proto_msgTypes[64]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ApplyNexusEndpointReplicationEventRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ApplyNexusEndpointReplicationEventRequest) ProtoMessage() {}

func (x *ApplyNexusEndpointReplicationEventRequest) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_matchingservice_v1_request_response_proto_msgTypes[64]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ApplyNexusEndpointReplicationEventRequest.ProtoReflect.Descriptor instead.
func (*ApplyNexusEndpointReplicationEventRequest) Descriptor() ([]byte, []int) {
	return file_temporal_server_api_matchingservice_v1_request_response_proto_rawDescGZIP(), []int{64}
}

func (x *ApplyNexusEndpointReplicationEventRequest) GetEndpoint() *v110.NexusEndpointEntry {
	if x != nil {
		return x.Endpoint
	}
	return nil
...
func (x *ApplyNexusEndpointReplicationEventRequest) GetOperation() v114.NexusEndpointOperation {
	if x != nil {
		return x.Operation
	}
	return v114.NexusEndpointOperation(0)
}

type ApplyNexusEndpointReplicationEventResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ApplyNexusEndpointReplicationEventResponse) Reset() {
	*x = ApplyNexusEndpointReplicationEventResponse{}
	mi := &file_temporal_server_api_matchingservice_v1_request_response_proto_msgTypes[65]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ApplyNexusEndpointReplicationEventResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ApplyNexusEndpointReplicationEventResponse) ProtoMessage() {}

func (x *ApplyNexusEndpointReplicationEventResponse) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_matchingservice_v1_request_response_proto_msgTypes[65]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ApplyNexusEndpointReplicationEventResponse.ProtoReflect.Descriptor instead.
func (*ApplyNexusEndpointReplicationEventResponse) Descriptor() ([]byte, []int) {
...
const file_temporal_server_api_matchingservice_v1_request_response_proto_rawDesc = "" +
	"\n" +
	"=temporal/server/api/matchingservice/v1/request_response.proto\x12&temporal.server.api.matchingservice.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a$temporal/api/common/v1/message.proto\x1a(temporal/api/deployment/v1/message.proto\x1a&temporal/api/enums/v1/task_queue.proto\x1a%temporal/api/history/v1/message.proto\x1a'temporal/api/taskqueue/v1/message.proto\x1a#temporal/api/query/v1/message.proto\x1a&temporal/api/protocol/v1/message.proto\x1a*temporal/server/api/clock/v1/message.proto\x1a/temporal/server/api/deployment/v1/message.proto\x1a.temporal/server/api/enums/v1/replication.proto\x1a,temporal/server/api/history/v1/message.proto\x1a.temporal/server/api/persistence/v1/nexus.proto\x1a4temporal/server/api/persistence/v1/task_queues.proto\x1a.temporal/server/api/taskqueue/v1/message.proto\x1a6temporal/api/workflowservice/v1/request_response.proto\x1a#temporal/api/nexus/v1/message.proto\"\xeb\x01\n" +
	...
	"\aentries\x18\x03 \x03(\v26.temporal.server.api.persistence.v1.NexusEndpointEntryR\aentries\"\xd3\x01\n" +
	")ApplyNexusEndpointReplicationEventRequest\x12R\n" +
	"\bendpoint\x18\x01 \x01(\v26.temporal.server.api.persistence.v1.NexusEndpointEntryR\bendpoint\x12R\n" +
	"\toperation\x18\x02 \x01(\x0e24.temporal.server.api.enums.v1.NexusEndpointOperationR\toperation\",\n" +
	"*ApplyNexusEndpointReplicationEventResponseB>Z<go.temporal.io/server/api/matchingservice/v1;matchingserviceb\x06proto3"
...
var file_temporal_server_api_matchingservice_v1_request_response_proto_msgTypes = make([]protoimpl.MessageInfo, 70)
var file_temporal_server_api_matchingservice_v1_request_response_proto_goTypes = []any{
	...
	(*ApplyNexusEndpointReplicationEventRequest)(nil),      // 64: temporal.server.api.matchingservice.v1.ApplyNexusEndpointReplicationEventRequest
	(*ApplyNexusEndpointReplicationEventResponse)(nil),     // 65: temporal.server.api.matchingservice.v1.ApplyNexusEndpointReplicationEventResponse
	nil, // 66: temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueResponse.QueriesEntry
	nil, // 67: temporal.server.api.matchingservice.v1.DescribeTaskQueuePartitionResponse.VersionsInfoInternalEntry
	(*UpdateWorkerBuildIdCompatibilityRequest_ApplyPublicRequest)(nil), // 68: temporal.server.api.matchingservice.v1.UpdateWorkerBuildIdCompatibilityRequest.ApplyPublicRequest
	(*UpdateWorkerBuildIdCompatibilityRequest_RemoveBuildIds)(nil),     // 69: temporal.server.api.matchingservice.v1.UpdateWorkerBuildIdCompatibilityRequest.RemoveBuildIds
	(*v1.PollWorkflowTaskQueueRequest)(nil),                            // 70: temporal.api.workflowservice.v1.PollWorkflowTaskQueueRequest
	(*v11.WorkflowExecution)(nil),                                      // 71: temporal.api.common.v1.WorkflowExecution
	(*v11.WorkflowType)(nil),                                           // 72: temporal.api.common.v1.WorkflowType
	(*v12.WorkflowQuery)(nil),                                          // 73: temporal.api.query.v1.WorkflowQuery
	(*v13.TransientWorkflowTaskInfo)(nil),                              // 74: temporal.server.api.history.v1.TransientWorkflowTaskInfo
	(*v14.TaskQueue)(nil),                                              // 75: temporal.api.taskqueue.v1.TaskQueue
	(*timestamppb.Timestamp)(nil),                                      // 76: google.protobuf.Timestamp
	(*v15.Message)(nil),                                                // 77: temporal.api.protocol.v1.Message
	(*v16.History)(nil),                                                // 78: temporal.api.history.v1.History
	(*v14.PollerScalingDecision)(nil),                                  // 79: temporal.api.taskqueue.v1.PollerScalingDecision
	(*v1.PollActivityTaskQueueRequest)(nil),                            // 80: temporal.api.workflowservice.v1.PollActivityTaskQueueRequest
	(*v11.ActivityType)(nil),                                           // 81: temporal.api.common.v1.ActivityType
	(*v11.Payloads)(nil),                                               // 82: temporal.api.common.v1.Payloads
	(*durationpb.Duration)(nil),                                        // 83: google.protobuf.Duration
	(*v11.Header)(nil),                                                 // 84: temporal.api.common.v1.Header
	(*v11.Priority)(nil),                                               // 85: temporal.api.common.v1.Priority
	(*v11.RetryPolicy)(nil),                                            // 86: temporal.api.common.v1.RetryPolicy
	(*v17.VectorClock)(nil),                                            // 87: temporal.server.api.clock.v1.VectorClock
	(*v18.TaskVersionDirective)(nil),                                   // 88: temporal.server.api.taskqueue.v1.TaskVersionDirective
	(*v18.TaskForwardInfo)(nil),                                        // 89: temporal.server.api.taskqueue.v1.TaskForwardInfo
	(*v1.QueryWorkflowRequest)(nil),                                    // 90: temporal.api.workflowservice.v1.QueryWorkflowRequest
	(*v12.QueryRejected)(nil),                                          // 91: temporal.api.query.v1.QueryRejected
	(*v1.RespondQueryTaskCompletedRequest)(nil),                        // 92: temporal.api.workflowservice.v1.RespondQueryTaskCompletedRequest
	(v19.TaskQueueType)(0),                                             // 93: temporal.api.enums.v1.TaskQueueType
	(*v1.DescribeTaskQueueRequest)(nil),                                // 94: temporal.api.workflowservice.v1.DescribeTaskQueueRequest
	(*v1.DescribeTaskQueueResponse)(nil),                               // 95: temporal.api.workflowservice.v1.DescribeTaskQueueResponse
	(*v18.TaskQueuePartition)(nil),                                     // 96: temporal.server.api.taskqueue.v1.TaskQueuePartition
	(*v14.TaskQueueVersionSelection)(nil),                              // 97: temporal.api.taskqueue.v1.TaskQueueVersionSelection
	(*v14.TaskQueuePartitionMetadata)(nil),                             // 98: temporal.api.taskqueue.v1.TaskQueuePartitionMetadata
	(*v1.GetWorkerVersioningRulesRequest)(nil),                         // 99: temporal.api.workflowservice.v1.GetWorkerVersioningRulesRequest
	(*v1.GetWorkerVersioningRulesResponse)(nil),                        // 100: temporal.api.workflowservice.v1.GetWorkerVersioningRulesResponse
	(*v1.UpdateWorkerVersioningRulesRequest)(nil),                      // 101: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest
	(*v1.UpdateWorkerVersioningRulesResponse)(nil),                     // 102: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesResponse
	(*v1.GetWorkerBuildIdCompatibilityRequest)(nil),                    // 103: temporal.api.workflowservice.v1.GetWorkerBuildIdCompatibilityRequest
	(*v1.GetWorkerBuildIdCompatibilityResponse)(nil),                   // 104: temporal.api.workflowservice.v1.GetWorkerBuildIdCompatibilityResponse
	(*v110.VersionedTaskQueueUserData)(nil),                            // 105: temporal.server.api.persistence.v1.VersionedTaskQueueUserData
	(*v111.Deployment)(nil),                                            // 106: temporal.api.deployment.v1.Deployment
	(*v112.TaskQueueData)(nil),                                         // 107: temporal.server.api.deployment.v1.TaskQueueData
	(*v112.DeploymentVersionData)(nil),                                 // 108: temporal.server.api.deployment.v1.DeploymentVersionData
	(*v112.WorkerDeploymentVersion)(nil),                               // 109: temporal.server.api.deployment.v1.WorkerDeploymentVersion
	(*v110.TaskQueueUserData)(nil),                                     // 110: temporal.server.api.persistence.v1.TaskQueueUserData
	(*v113.Request)(nil),                                               // 111: temporal.api.nexus.v1.Request
	(*v113.HandlerError)(nil),                                          // 112: temporal.api.nexus.v1.HandlerError
	(*v113.Response)(nil),                                              // 113: temporal.api.nexus.v1.Response
	(*v1.PollNexusTaskQueueRequest)(nil),                               // 114: temporal.api.workflowservice.v1.PollNexusTaskQueueRequest
	(*v1.PollNexusTaskQueueResponse)(nil),                              // 115: temporal.api.workflowservice.v1.PollNexusTaskQueueResponse
	(*v1.RespondNexusTaskCompletedRequest)(nil),                        // 116: temporal.api.workflowservice.v1.RespondNexusTaskCompletedRequest
	(*v1.RespondNexusTaskFailedRequest)(nil),                           // 117: temporal.api.workflowservice.v1.RespondNexusTaskFailedRequest
	(*v110.NexusEndpointSpec)(nil),                                     // 118: temporal.server.api.persistence.v1.NexusEndpointSpec
	(*v110.NexusEndpointEntry)(nil),                                    // 119: temporal.server.api.persistence.v1.NexusEndpointEntry
	(v114.NexusEndpointOperation)(0),                                   // 120: temporal.server.api.enums.v1.NexusEndpointOperation
	(*v18.TaskQueueVersionInfoInternal)(nil),                           // 121: temporal.server.api.taskqueue.v1.TaskQueueVersionInfoInternal
	(*v1.UpdateWorkerBuildIdCompatibilityRequest)(nil),                 // 122: temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest
}
var file_temporal_server_api_matchingservice_v1_request_response_proto_depIdxs = []int32{
	70,  // 0: temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueRequest.poll_request:type_name -> temporal.api.workflowservice.v1.PollWorkflowTaskQueueRequest
	71,  // 1: temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueResponse.workflow_execution:type_name -> temporal.api.common.v1.WorkflowExecution
	72,  // 2: temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueResponse.workflow_type:type_name -> temporal.api.common.v1.WorkflowType
	73,  // 3: temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueResponse.query:type_name -> temporal.api.query.v1.WorkflowQuery
	74,  // 4: temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueResponse.transient_workflow_task:type_name -> temporal.server.api.history.v1.TransientWorkflowTaskInfo
	75,  // 5: temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueResponse.workflow_execution_task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	76,  // 6: temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueResponse.scheduled_time:type_name -> google.protobuf.Timestamp
	76,  // 7: temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueResponse.started_time:type_name -> google.protobuf.Timestamp
	66,  // 8: temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueResponse.queries:type_name -> temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueResponse.QueriesEntry
	77,  // 9: temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueResponse.messages:type_name -> temporal.api.protocol.v1.Message
	78,  // 10: temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueResponse.history:type_name -> temporal.api.history.v1.History
	79,  // 11: temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueResponse.poller_scaling_decision:type_name -> temporal.api.taskqueue.v1.PollerScalingDecision
	80,  // 12: temporal.server.api.matchingservice.v1.PollActivityTaskQueueRequest.poll_request:type_name -> temporal.api.workflowservice.v1.PollActivityTaskQueueRequest
	71,  // 13: temporal.server.api.matchingservice.v1.PollActivityTaskQueueResponse.workflow_execution:type_name -> temporal.api.common.v1.WorkflowExecution
	81,  // 14: temporal.server.api.matchingservice.v1.PollActivityTaskQueueResponse.activity_type:type_name -> temporal.api.common.v1.ActivityType
	82,  // 15: temporal.server.api.matchingservice.v1.PollActivityTaskQueueResponse.input:type_name -> temporal.api.common.v1.Payloads
	76,  // 16: temporal.server.api.matchingservice.v1.PollActivityTaskQueueResponse.scheduled_time:type_name -> google.protobuf.Timestamp
	83,  // 17: temporal.server.api.matchingservice.v1.PollActivityTaskQueueResponse.schedule_to_close_timeout:type_name -> google.protobuf.Duration
	76,  // 18: temporal.server.api.matchingservice.v1.PollActivityTaskQueueResponse.started_time:type_name -> google.protobuf.Timestamp
	83,  // 19: temporal.server.api.matchingservice.v1.PollActivityTaskQueueResponse.start_to_close_timeout:type_name -> google.protobuf.Duration
	83,  // 20: temporal.server.api.matchingservice.v1.PollActivityTaskQueueResponse.heartbeat_timeout:type_name -> google.protobuf.Duration
	76,  // 21: temporal.server.api.matchingservice.v1.PollActivityTaskQueueResponse.current_attempt_scheduled_time:type_name -> google.protobuf.Timestamp
	82,  // 22: temporal.server.api.matchingservice.v1.PollActivityTaskQueueResponse.heartbeat_details:type_name -> temporal.api.common.v1.Payloads
	72,  // 23: temporal.server.api.matchingservice.v1.PollActivityTaskQueueResponse.workflow_type:type_name -> temporal.api.common.v1.WorkflowType
	...
	85,  // 26: temporal.server.api.matchingservice.v1.PollActivityTaskQueueResponse.priority:type_name -> temporal.api.common.v1.Priority
	86,  // 27: temporal.server.api.matchingservice.v1.PollActivityTaskQueueResponse.retry_policy:type_name -> temporal.api.common.v1.RetryPolicy
	71,  // 28: temporal.server.api.matchingservice.v1.AddWorkflowTaskRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	75,  // 29: temporal.server.api.matchingservice.v1.AddWorkflowTaskRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	83,  // 30: temporal.server.api.matchingservice.v1.AddWorkflowTaskRequest.schedule_to_start_timeout:type_name -> google.protobuf.Duration
	87,  // 31: temporal.server.api.matchingservice.v1.AddWorkflowTaskRequest.clock:type_name -> temporal.server.api.clock.v1.VectorClock
	88,  // 32: temporal.server.api.matchingservice.v1.AddWorkflowTaskRequest.version_directive:type_name -> temporal.server.api.taskqueue.v1.TaskVersionDirective
	89,  // 33: temporal.server.api.matchingservice.v1.AddWorkflowTaskRequest.forward_info:type_name -> temporal.server.api.taskqueue.v1.TaskForwardInfo
	85,  // 34: temporal.server.api.matchingservice.v1.AddWorkflowTaskRequest.priority:type_name -> temporal.api.common.v1.Priority
	71,  // 35: temporal.server.api.matchingservice.v1.AddActivityTaskRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	75,  // 36: temporal.server.api.matchingservice.v1.AddActivityTaskRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	83,  // 37: temporal.server.api.matchingservice.v1.AddActivityTaskRequest.schedule_to_start_timeout:type_name -> google.protobuf.Duration
	87,  // 38: temporal.server.api.matchingservice.v1.AddActivityTaskRequest.clock:type_name -> temporal.server.api.clock.v1.VectorClock
	88,  // 39: temporal.server.api.matchingservice.v1.AddActivityTaskRequest.version_directive:type_name -> temporal.server.api.taskqueue.v1.TaskVersionDirective
	89,  // 40: temporal.server.api.matchingservice.v1.AddActivityTaskRequest.forward_info:type_name -> temporal.server.api.taskqueue.v1.TaskForwardInfo
	85,  // 41: temporal.server.api.matchingservice.v1.AddActivityTaskRequest.priority:type_name -> temporal.api.common.v1.Priority
	75,  // 42: temporal.server.api.matchingservice.v1.QueryWorkflowRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	90,  // 43: temporal.server.api.matchingservice.v1.QueryWorkflowRequest.query_request:type_name -> temporal.api.workflowservice.v1.QueryWorkflowRequest
	88,  // 44: temporal.server.api.matchingservice.v1.QueryWorkflowRequest.version_directive:type_name -> temporal.server.api.taskqueue.v1.TaskVersionDirective
	89,  // 45: temporal.server.api.matchingservice.v1.QueryWorkflowRequest.forward_info:type_name -> temporal.server.api.taskqueue.v1.TaskForwardInfo
	85,  // 46: temporal.server.api.matchingservice.v1.QueryWorkflowRequest.priority:type_name -> temporal.api.common.v1.Priority
	82,  // 47: temporal.server.api.matchingservice.v1.QueryWorkflowResponse.query_result:type_name -> temporal.api.common.v1.Payloads
	91,  // 48: temporal.server.api.matchingservice.v1.QueryWorkflowResponse.query_rejected:type_name -> temporal.api.query.v1.QueryRejected
	75,  // 49: temporal.server.api.matchingservice.v1.RespondQueryTaskCompletedRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	92,  // 50: temporal.server.api.matchingservice.v1.RespondQueryTaskCompletedRequest.completed_request:type_name -> temporal.api.workflowservice.v1.RespondQueryTaskCompletedRequest
	93,  // 51: temporal.server.api.matchingservice.v1.CancelOutstandingPollRequest.task_queue_type:type_name -> temporal.api.enums.v1.TaskQueueType
	75,  // 52: temporal.server.api.matchingservice.v1.CancelOutstandingPollRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	94,  // 53: temporal.server.api.matchingservice.v1.DescribeTaskQueueRequest.desc_request:type_name -> temporal.api.workflowservice.v1.DescribeTaskQueueRequest
	95,  // 54: temporal.server.api.matchingservice.v1.DescribeTaskQueueResponse.desc_response:type_name -> temporal.api.workflowservice.v1.DescribeTaskQueueResponse
	96,  // 55: temporal.server.api.matchingservice.v1.DescribeTaskQueuePartitionRequest.task_queue_partition:type_name -> temporal.server.api.taskqueue.v1.TaskQueuePartition
	97,  // 56: temporal.server.api.matchingservice.v1.DescribeTaskQueuePartitionRequest.versions:type_name -> temporal.api.taskqueue.v1.TaskQueueVersionSelection
	67,  // 57: temporal.server.api.matchingservice.v1.DescribeTaskQueuePartitionResponse.versions_info_internal:type_name -> temporal.server.api.matchingservice.v1.DescribeTaskQueuePartitionResponse.VersionsInfoInternalEntry
	75,  // 58: temporal.server.api.matchingservice.v1.ListTaskQueuePartitionsRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	98,  // 59: temporal.server.api.matchingservice.v1.ListTaskQueuePartitionsResponse.activity_task_queue_partitions:type_name -> temporal.api.taskqueue.v1.TaskQueuePartitionMetadata
	98,  // 60: temporal.server.api.matchingservice.v1.ListTaskQueuePartitionsResponse.workflow_task_queue_partitions:type_name -> temporal.api.taskqueue.v1.TaskQueuePartitionMetadata
	68,  // 61: temporal.server.api.matchingservice.v1.UpdateWorkerBuildIdCompatibilityRequest.apply_public_request:type_name -> temporal.server.api.matchingservice.v1.UpdateWorkerBuildIdCompatibilityRequest.ApplyPublicRequest
	69,  // 62: temporal.server.api.matchingservice.v1.UpdateWorkerBuildIdCompatibilityRequest.remove_build_ids:type_name -> temporal.server.api.matchingservice.v1.UpdateWorkerBuildIdCompatibilityRequest.RemoveBuildIds
	99,  // 63: temporal.server.api.matchingservice.v1.GetWorkerVersioningRulesRequest.request:type_name -> temporal.api.workflowservice.v1.GetWorkerVersioningRulesRequest
	100, // 64: temporal.server.api.matchingservice.v1.GetWorkerVersioningRulesResponse.response:type_name -> temporal.api.workflowservice.v1.GetWorkerVersioningRulesResponse
	101, // 65: temporal.server.api.matchingservice.v1.UpdateWorkerVersioningRulesRequest.request:type_name -> temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest
	102, // 66: temporal.server.api.matchingservice.v1.UpdateWorkerVersioningRulesResponse.response:type_name -> temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesResponse
	103, // 67: temporal.server.api.matchingservice.v1.GetWorkerBuildIdCompatibilityRequest.request:type_name -> temporal.api.workflowservice.v1.GetWorkerBuildIdCompatibilityRequest
	104, // 68: temporal.server.api.matchingservice.v1.GetWorkerBuildIdCompatibilityResponse.response:type_name -> temporal.api.workflowservice.v1.GetWorkerBuildIdCompatibilityResponse
	93,  // 69: temporal.server.api.matchingservice.v1.GetTaskQueueUserDataRequest.task_queue_type:type_name -> temporal.api.enums.v1.TaskQueueType
	105, // 70: temporal.server.api.matchingservice.v1.GetTaskQueueUserDataResponse.user_data:type_name -> temporal.server.api.persistence.v1.VersionedTaskQueueUserData
	93,  // 71: temporal.server.api.matchingservice.v1.SyncDeploymentUserDataRequest.task_queue_type:type_name -> temporal.api.enums.v1.TaskQueueType
	93,  // 72: temporal.server.api.matchingservice.v1.SyncDeploymentUserDataRequest.task_queue_types:type_name -> temporal.api.enums.v1.TaskQueueType
	106, // 73: temporal.server.api.matchingservice.v1.SyncDeploymentUserDataRequest.deployment:type_name -> temporal.api.deployment.v1.Deployment
	107, // 74: temporal.server.api.matchingservice.v1.SyncDeploymentUserDataRequest.data:type_name -> temporal.server.api.deployment.v1.TaskQueueData
	108, // 75: temporal.server.api.matchingservice.v1.SyncDeploymentUserDataRequest.update_version_data:type_name -> temporal.server.api.deployment.v1.DeploymentVersionData
	109, // 76: temporal.server.api.matchingservice.v1.SyncDeploymentUserDataRequest.forget_version:type_name -> temporal.server.api.deployment.v1.WorkerDeploymentVersion
	110, // 77: temporal.server.api.matchingservice.v1.ApplyTaskQueueUserDataReplicationEventRequest.user_data:type_name -> temporal.server.api.persistence.v1.TaskQueueUserData
	96,  // 78: temporal.server.api.matchingservice.v1.ForceLoadTaskQueuePartitionRequest.task_queue_partition:type_name -> temporal.server.api.taskqueue.v1.TaskQueuePartition
	93,  // 79: temporal.server.api.matchingservice.v1.ForceUnloadTaskQueueRequest.task_queue_type:type_name -> temporal.api.enums.v1.TaskQueueType
	96,  // 80: temporal.server.api.matchingservice.v1.ForceUnloadTaskQueuePartitionRequest.task_queue_partition:type_name -> temporal.server.api.taskqueue.v1.TaskQueuePartition
	105, // 81: temporal.server.api.matchingservice.v1.UpdateTaskQueueUserDataRequest.user_data:type_name -> temporal.server.api.persistence.v1.VersionedTaskQueueUserData
	110, // 82: temporal.server.api.matchingservice.v1.ReplicateTaskQueueUserDataRequest.user_data:type_name -> temporal.server.api.persistence.v1.TaskQueueUserData
	75,  // 83: temporal.server.api.matchingservice.v1.DispatchNexusTaskRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	111, // 84: temporal.server.api.matchingservice.v1.DispatchNexusTaskRequest.request:type_name -> temporal.api.nexus.v1.Request
	89,  // 85: temporal.server.api.matchingservice.v1.DispatchNexusTaskRequest.forward_info:type_name -> temporal.server.api.taskqueue.v1.TaskForwardInfo
	112, // 86: temporal.server.api.matchingservice.v1.DispatchNexusTaskResponse.handler_error:type_name -> temporal.api.nexus.v1.HandlerError
	113, // 87: temporal.server.api.matchingservice.v1.DispatchNexusTaskResponse.response:type_name -> temporal.api.nexus.v1.Response
	114, // 88: temporal.server.api.matchingservice.v1.PollNexusTaskQueueRequest.request:type_name -> temporal.api.workflowservice.v1.PollNexusTaskQueueRequest
	115, // 89: temporal.server.api.matchingservice.v1.PollNexusTaskQueueResponse.response:type_name -> temporal.api.workflowservice.v1.PollNexusTaskQueueResponse
	75,  // 90: temporal.server.api.matchingservice.v1.RespondNexusTaskCompletedRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	116, // 91: temporal.server.api.matchingservice.v1.RespondNexusTaskCompletedRequest.request:type_name -> temporal.api.workflowservice.v1.RespondNexusTaskCompletedRequest
	75,  // 92: temporal.server.api.matchingservice.v1.RespondNexusTaskFailedRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	117, // 93: temporal.server.api.matchingservice.v1.RespondNexusTaskFailedRequest.request:type_name -> temporal.api.workflowservice.v1.RespondNexusTaskFailedRequest
	118, // 94: temporal.server.api.matchingservice.v1.CreateNexusEndpointRequest.spec:type_name -> temporal.server.api.persistence.v1.NexusEndpointSpec
	119, // 95: temporal.server.api.matchingservice.v1.CreateNexusEndpointResponse.entry:type_name -> temporal.server.api.persistence.v1.NexusEndpointEntry
	118, // 96: temporal.server.api.matchingservice.v1.UpdateNexusEndpointRequest.spec:type_name -> temporal.server.api.persistence.v1.NexusEndpointSpec
	119, // 97: temporal.server.api.matchingservice.v1.UpdateNexusEndpointResponse.entry:type_name -> temporal.server.api.persistence.v1.NexusEndpointEntry
	119, // 98: temporal.server.api.matchingservice.v1.ListNexusEndpointsResponse.entries:type_name -> temporal.server.api.persistence.v1.NexusEndpointEntry
	119, // 99: temporal.server.api.matchingservice.v1.ApplyNexusEndpointReplicationEventRequest.endpoint:type_name -> temporal.server.api.persistence.v1.NexusEndpointEntry
	120, // 100: temporal.server.api.matchingservice.v1.ApplyNexusEndpointReplicationEventRequest.operation:type_name -> temporal.server.api.enums.v1.NexusEndpointOperation
	73,  // 101: temporal.server.api.matchingservice.v1.PollWorkflowTaskQueueResponse.QueriesEntry.value:type_name -> temporal.api.query.v1.WorkflowQuery
	121, // 102: temporal.server.api.matchingservice.v1.DescribeTaskQueuePartitionResponse.VersionsInfoInternalEntry.value:type_name -> temporal.server.api.taskqueue.v1.TaskQueueVersionInfoInternal
	122, // 103: temporal.server.api.matchingservice.v1.UpdateWorkerBuildIdCompatibilityRequest.ApplyPublicRequest.request:type_name -> temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest
